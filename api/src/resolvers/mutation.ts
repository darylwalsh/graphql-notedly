...
module.exports = {
  newNote: async (_: any, args: Note, { models, user }: any) => {
  ...
  deleteNote: async (_: any, { id }: { id: string }, { models, user }: any) => {
  ...
  toggleFavorite: async (
    ...
    if (!user) {
      throw new AuthenticationError('You must be signed in to toggle favorites')
    }
